...
const std::string vertexShaderPath = std::string(srcPath + "/ch05-2 Coordinate Depth/shader.vs");
const std::string fragmentShaderPath = std::string(srcPath + "/ch05-2 Coordinate Depth/shader.fs");

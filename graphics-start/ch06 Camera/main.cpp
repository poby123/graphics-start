...
//  graphics-start
//
//  Created by wonju Lee on 2023/10/03.
//
...
const std::string vertexShaderPath = std::string(srcPath + "/ch06 Camera/shader.vs");
const std::string fragmentShaderPath = std::string(srcPath + "/ch06 Camera/shader.fs");
